...
export const CategoryCard = ({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      className={cn(
        'relative overflow-hidden rounded-xl aspect-square glass',
        'hover:glow-orange transition-all duration-300 group'
      )}
    >
      {/* Background */}
      <div className="absolute inset-0">
        {bgImage ? (
          ...
          <div 
            className="w-full h-full opacity-40 group-hover:opacity-60 transition-opacity duration-300"
