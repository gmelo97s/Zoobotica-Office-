...
export const products: Product[] = [
  // ========== SERVIÇOS DE CLÍNICA (12 itens) ==========
  {
    ...
    price: 150.00,
    description: 'Atendimento veterinário completo com avaliação geral do pet',
  ...
  },
  {
    ...
    price: 90.00,
    description: 'Vacina polivalente contra cinomose, parvovirose, hepatite e outras doenças',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 85.00,
    description: 'Proteção contra rinotraqueíte, calicivirose e panleucopenia',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 65.00,
    description: 'Proteção contra raiva para cães e gatos',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 450.00,
    description: 'Procedimento cirúrgico com anestesia inalatória e monitoramento',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 550.00,
    description: 'Ovariohisterectomia com anestesia inalatória',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 120.00,
    description: 'Avaliação de fígado, rins e glicose',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 220.00,
    description: 'Exame de imagem para avaliação de órgãos internos',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    name: 'Raio-X Digital',
    price: 150.00,
    description: 'Radiografia digital com laudo veterinário',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 95.00,
    description: 'Identificação permanente com registro nacional',
    category: 'Serviços de Clínica',
  ...
  },
  {
    ...
    price: 350.00,
    description: 'Profilaxia dental com ultrassom sob anestesia',
    category: 'Serviços de Clínica',
  ...
  // ========== BOUTIQUE E ACESSÓRIOS (12 itens) ==========
  {
    ...
    price: 89.00,
    description: 'Coleira em couro legítimo com fivela de metal',
  ...
  },
  {
    ...
    price: 75.00,
    description: 'Guia retrátil para passeios com mais liberdade',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 95.00,
    description: 'Peitoral ergonômico que reduz puxões durante passeios',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 189.00,
    description: 'Cama com espuma viscoelástica para conforto articular',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 125.00,
    description: 'Caminha fechada estilo iglu, ideal para gatos',
    category: 'Boutique e Acessórios',
    tags: ['cama', 'iglu', 'gato'],
  },
  {
    ...
    price: 65.00,
    description: 'Comedouro e bebedouro em aço inox com suporte',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 145.00,
    description: 'Fonte de água com filtro de carvão ativado',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    name: 'Kong Classic M',
    price: 75.00,
    description: 'Brinquedo indestrutível para rechear com petiscos',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 220.00,
    description: 'Torre com sisal, plataformas e tocas',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 185.00,
    description: 'Aprovada para viagens de avião, até 7kg',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 79.00,
    description: 'Roupa quentinha para dias frios',
    category: 'Boutique e Acessórios',
  ...
  },
  {
    ...
    price: 135.00,
    description: 'Proteção impermeável para banco traseiro',
    category: 'Boutique e Acessórios',
  ...
  // ========== FARMÁCIA PET (12 itens) ==========
  {
    ...
    price: 165.00,
    description: 'Antipulgas e carrapatos com 3 meses de proteção',
  ...
  },
  {
    ...
    name: 'NexGard 4-10kg',
    price: 95.00,
    description: 'Antipulgas e carrapatos mensal mastigável',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 85.00,
    description: 'Proteção contra pulgas, vermes e ácaros',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    name: 'Milbemax Gatos',
    price: 45.00,
    description: 'Vermífugo para gatos adultos',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 55.00,
    description: 'Shampoo antibacteriano para pele sensível',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 85.00,
    description: 'Suplemento para articulações - 60 comprimidos',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 68.00,
    description: 'Suplemento para pele e pelagem - 60 cápsulas',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 48.00,
    description: 'Probiótico para flora intestinal - 6 cápsulas',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 38.00,
    description: 'Lubrificante ocular para olhos ressecados',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 42.00,
    description: 'Solução otológica para limpeza de ouvidos',
    category: 'Farmácia Pet',
  ...
  },
  {
    ...
    price: 35.00,
    description: 'Pomada cicatrizante e antibacteriana',
    category: 'Farmácia Pet',
  ...
  // ========== NUTRIÇÃO PARA GATOS (12 itens) ==========
  {
    ...
    price: 215.00,
    description: 'Ração premium para gatos que vivem dentro de casa',
  ...
  },
  {
    ...
    price: 145.00,
    description: 'Ração super premium para gatos castrados',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 98.00,
    description: 'Ração para gatos até 12 meses',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 4.50,
    description: 'Alimento úmido em diversos sabores',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 7.90,
    description: 'Alimento úmido premium com pedaços suculentos',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 195.00,
    description: 'Ração veterinária para suporte renal',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 12.00,
    description: 'Petisco crocante irresistível para gatos',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 28.00,
    description: 'Areia sanitária com controle de odor',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 35.00,
    description: 'Areia de sílica cristais com alta absorção',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 15.00,
    description: 'Graminha natural para digestão e entretenimento',
    category: 'Nutrição para Gatos',
  ...
  },
  {
    ...
    price: 320.00,
    description: 'Ração super premium com nutrição balanceada',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 125.00,
    description: 'Ração para cães adultos sabor carne',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 175.00,
    description: 'Ração premium com pedaços de carne',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 450.00,
    description: 'Ração veterinária para alergias alimentares',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 395.00,
    description: 'Ração para controle de peso',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 5.50,
    description: 'Alimento úmido para cães adultos',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 35.00,
    description: 'Petisco em tiras sabor carne',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 25.00,
    description: 'Osso natural para roer e limpar os dentes',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 38.00,
    description: 'Pasta sem xilitol, segura para cães',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 32.00,
    description: 'Biscoitos com benefícios para saúde',
    category: 'Nutrição para Cães',
  ...
  },
  {
    ...
    price: 35.00,
    description: 'Porção de AN congelada pronta para servir',
    category: 'Nutrição para Cães',
  ...
  // ========== DAY CARE E HOTEL (10 itens) ==========
  {
    ...
    price: 85.00,
    description: 'Creche diurna com atividades e socialização (7h às 19h)',
  ...
  },
  {
    ...
    price: 380.00,
    description: 'Pacote semanal com desconto especial',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 700.00,
    description: 'Pacote quinzenal com economia de 18%',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 120.00,
    description: 'Hospedagem com acompanhamento 24h e 3 passeios',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 180.00,
    description: 'Quarto individual com câmera 24h e 4 passeios',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 540.00,
    description: 'Hospedagem com 10% de desconto',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 25.00,
    description: 'Passeio extra de 20 minutos',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 55.00,
    description: 'Banho completo durante a estadia',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 120.00,
    description: 'Sessão individual de 45 minutos',
    category: 'Day Care e Hotel',
  ...
  },
  {
    ...
    price: 35.00,
    description: 'Transporte com conforto e segurança (até 10km)',
    category: 'Day Care e Hotel',
  ...
  // ========== BANHO E TOSA (12 itens) ==========
  {
    ...
    price: 55.00,
    description: 'Banho completo para cães até 10kg',
  ...
  },
  {
    ...
    price: 70.00,
    description: 'Banho completo para cães de 11 a 25kg',
    category: 'Banho e Tosa',
    tags: ['banho', 'médio'],
    popular: true
  },
  {
    ...
    price: 95.00,
    description: 'Banho completo para cães acima de 25kg',
    category: 'Banho e Tosa',
    tags: ['banho', 'grande'],
  },
  {
  ...
  },
  {
    ...
    price: 65.00,
    description: 'Tosa artística e delicada feita à mão',
    category: 'Banho e Tosa',
  ...
  },
  {
    ...
    name: 'Tosa Higiênica',
    price: 40.00,
    description: 'Tosa das áreas íntimas, patas e face',
    category: 'Banho e Tosa',
    tags: ['tosa', 'higiênica'],
  },
  {
  ...
  },
  {
    ...
    name: 'SPA Completo',
    price: 180.00,
    description: 'Banho, tosa, hidratação, aromaterapia e massagem',
    category: 'Banho e Tosa',
  ...
  },
  {
    ...
    price: 75.00,
    description: 'Banho especial e delicado para felinos',
    category: 'Banho e Tosa',
