...
const mosaicoImages = [
  { src: mosaico01, alt: 'Supra Bar - Escada e ambiente' },
  { src: mosaico02, alt: 'Supra Bar - Brinde com cervejas' },
  { src: mosaico03, alt: 'Supra Bar - Mural do leão' },
  { src: mosaico04, alt: 'Supra Bar - Bartender preparando drink' },
  { src: mosaico05, alt: 'Supra Bar - Mesa com bebidas' },
  { src: mosaico06, alt: 'Supra Bar - Fachada' },
];
...
export const Landing = () => {
  ...
  const scrollToMosaic = () => {
    document.getElementById('ambiente')?.scrollIntoView({ behavior: 'smooth' });
  };
    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
        ...
        <div className="max-w-md w-full space-y-8 text-center relative z-10">
          ...
          >
            <motion.h1
              className="text-4xl md:text-5xl font-black text-foreground tracking-wider uppercase font-bebas"
              initial={{ opacity: 0, y: 30 }}
              animate={{ 
                opacity: 1, 
                y: 0,
                textShadow: [
                  '0 0 20px hsl(var(--neon-orange) / 0.5), 0 0 40px hsl(var(--neon-orange) / 0.3)',
                  '0 0 30px hsl(var(--neon-orange) / 0.7), 0 0 60px hsl(var(--neon-orange) / 0.4)',
                  '0 0 20px hsl(var(--neon-orange) / 0.5), 0 0 40px hsl(var(--neon-orange) / 0.3)'
                ]
              }}
              transition={{
                opacity: { duration: 0.8, delay: 0.3 },
                y: { duration: 0.8, delay: 0.3, type: 'spring' },
      ...
      <section id="ambiente" className="min-h-screen py-12 px-4 sm:px-6 bg-gradient-to-b from-background to-background/95">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            <h2
              className="text-3xl md:text-4xl font-black text-foreground uppercase text-glow-orange font-bebas tracking-wider"
            >
